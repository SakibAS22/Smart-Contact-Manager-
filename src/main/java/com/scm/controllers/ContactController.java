...
public class ContactController {
    ...
    public String addContactView(Model model){
        ...
        // contactForm.setName("Sakib Aslam Sankeshwarkar");
        // contactForm.setAddress("453 B ward");
    ...
    public String saveContact(@Valid @ModelAttribute ContactForm contactForm, BindingResult result,
        ...
        if(result.hasErrors()){
            ...
            .content("please correct the following message")
        ...
        //! 4 set the message to be displayed on the view
